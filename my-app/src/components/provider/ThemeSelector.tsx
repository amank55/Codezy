...
import { CircleOff, Cloud, Github, Laptop, Moon, Palette, Sun,Code,Terminal,Zap,Flame } from "lucide-react";
import useMounted from "../hooks/useMounted";
  ...
  const THEME_ICONS: Record<string, React.ReactNode> = {
    ...
    "dracula": <Code className="size-4" />,
    "nord": <Terminal className="size-4" />,
    "ayu-mirage": <Zap className="size-4" />,
    "night-owl": <Flame className="size-4" />,
    "one-dark": <CircleOff className="size-4" />
  };
